...
function cartItemTemplate(arr, idOfItem) {
    ...
    <div class="cart__item-main">
        ...
        <div class="cart__item-info">
            ...
            <p><span class="cart__item-price">${arr[idOfItem].price}</span> <span class="currency">грн/кг</span></p>
        </div>
    </div>
    ...
    <p class="cart__item-sum"><span class="sum-text">${arr[idOfItem].price}</span> грн</p>
    </div>
    `
}
